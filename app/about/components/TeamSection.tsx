...
export default function TeamSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set(["#imgTop", "#imgLeftTop", "#imgRightTop", "#imgLeftBottom", "#imgRightBottom"], { 
      ...
      const teamTl = gsap.timeline({
        scrollTrigger: {
          trigger: section,
          start: "top top",
          // 1. INCREASED DISTANCE: Higher number = slower animation
          end: "+=3000", 
          // 2. PINNING: Locks the section so it doesn't scroll away while animating
          pin: true,
          scrub: 1.2,
      ...
      teamTl
        ...
        .to(`.${styles.panelContent}`, {
          ...
          stagger: 0.05,
          onStart: () => {
            const counters = section.querySelectorAll(`.${styles.statNumber}`);
      ...
      // 3. Ensure production calculation is accurate
      setTimeout(() => ScrollTrigger.refresh(), 500);

    }, section); // Scope selectors to the section
  ...
  return (
    <section ref={sectionRef} id="teamSection" className={styles.teamSection}>
      <div className={styles.teamSticky}>
        ...
        <div id="imgTop" className={`${styles.teamImage} ${styles.imgTop}`}><img src="/img/founder.png" alt="Team member" /></div>
        <div id="imgLeftTop" className={`${styles.teamImage} ${styles.imgLeftTop}`}><img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=500&fit=crop" alt="Team member" /></div>
        <div id="imgRightTop" className={`${styles.teamImage} ${styles.imgRightTop}`}><img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=500&fit=crop" alt="Team member" /></div>
        <div id="imgLeftBottom" className={`${styles.teamImage} ${styles.imgLeftBottom}`}><img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop" alt="Team member" /></div>
        <div id="imgRightBottom" className={`${styles.teamImage} ${styles.imgRightBottom}`}><img src="https://images.unsplash.com/photo-1566492031773-4f4e44671857?w=400&h=500&fit=crop" alt="Team member" /></div>

        <div id="centerImage" className={styles.teamCenterImage}><img src="/img/black.png" alt="Featured team member" /></div>
