    ...
    <section className="tw-relative tw-py-20 tw-px-4 tw-sm-px-6 tw-lg-px-8 tw-overflow-hidden bg-white">
      ...
      <div className="container tw-max-w-7xl tw-mx-auto tw-relative tw-z-10">
          ...
          <div className="bento-grid">
            ...
            <div className="dark-card card-4 tw-rounded-3xl tw-p-8 tw-text-white tw-relative tw-group tw-cursor-pointer tw-overflow-hidden" data-card="4">
              ...
              <div className="tw-absolute tw-inset-0 tw-rounded-3xl tw-opacity-0 tw-pe-none"
                   style={{ background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.2), transparent)', backgroundSize: '200% 100%', animation: 'shimmer 2s infinite' }}></div>
            </div>
          </div>
        </div>
        ...
        {/* <div className="tw-mt-16 tw-flex tw-flex-col tw-sm-flex-row tw-items-center tw-gap-6 reveal-bottom tw-opacity-0">
          ...
          <button className="magnetic-btn magnetic-btn2 tw-bg-slate-900 tw-hover-bg-slate-800 tw-text-white tw-px-8 tw-py-4 tw-rounded-full tw-font-medium tw-flex tw-items-center tw-gap-2 tw-transition-all tw-duration-300 tw-hover-shadow-2xl tw-shadow-slate-900-20 tw-hover--translate-y-1">
